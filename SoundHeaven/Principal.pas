...
begin
  ...
  if TaskButtonCount = 0 then
    HideTaskBar; // Chama a animação para esconder o painel
end;
...
begin
  ...
  begin
    ...
    pnlTaskBar.Height := 0; // Começa escondido
    ShowTaskBar; // Chama a animação para mostrar o painel
  end;
end;
...
begin
  ...
  pnlTaskBar.Height := 0; // Começa com altura zero para deslizar ao mostrar
  TaskButtonCount := 0;
end;
